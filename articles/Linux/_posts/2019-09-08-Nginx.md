...
* **正向代理**：是代理客户端，为客户端收发请求，使真实客户端对服务器不可见，服务端并不知道请求真实的请求客户端是谁。最典型的就是VPN，比如你想访问谷歌，国内 IP 是访问不了的，但是如果我把电脑的对外公网 IP 换成美国的 IP 地址就能访问了。所以我们把请求先发到 VPN 服务器上，这样对于服务端看到的 IP 就是 VPN 服务器的 IP，这样就能顺利访问了。
