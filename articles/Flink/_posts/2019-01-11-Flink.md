...
![img.png](../../../assets/flink/flink_job_process.png)

## 架构概览
Flink架构中有三个重要的角色：
- Client
    - 负责处理用户代码，编译JobGraph，并且提交作业到JobManager
- JobManager
    - 负责部署JobGraph、管理TaskManager、管理作业运行状态
- TaskManager
    - 负责执行具体的Task

![img_1.png](../../../assets/flink/flink_overview.png)
