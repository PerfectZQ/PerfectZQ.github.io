...
　　参考[官方手册：开始Hive安装和配置](https://cwiki.apache.org/confluence/display/Hive/GettingStarted#GettingStarted-InstallationandConfiguration)
...
　　参考[官方文档](https://cwiki.apache.org/confluence/display/Hive/Home)

　　LanguageManual 语法手册[官方教程](https://cwiki.apache.org/confluence/display/Hive/LanguageManual)
## 安装过程
...
* HWI：其实就是hive web interface的缩写它是hive的web借口，是hive cli的一个web替代方案
...
### HWI
启动 HWI，用于通过浏览器来访问hive，浏览器访问地址是：127.0.0.1:9999/hwi
