...
make: *** [all] Error 2
```
[https://stackoverflow.com/questions/37103054/redis-installation-fails-when-running-make-command](https://stackoverflow.com/questions/37103054/redis-installation-fails-when-running-make-command)

```shell
$ make distclean
$ make
```
[What does make distclean do?](https://askubuntu.com/questions/477788/what-does-make-distclean-do)
