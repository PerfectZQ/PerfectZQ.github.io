...
## Kafka Tools 管理工具
　　在`$KAFKA_HOME/bin`目录下，放着kafka常用的一些工具脚本，这些类的实现都是放在源码的kafka/core/src/main/scala/kafka/tools/路径下。
...
./kafka-consumer-offset-checker.sh --zookeeper 10.4.121.218:3333,c13-139:2181,c13-141:2181 --topic mytopic --group xb_id --broker-info
