...
$ bin/kafka-manager -Dconfig.file=/usr/share/kafka-manager/conf/application.conf -Dapplication.home=/usr/share/kafka-manager

# 也可以修改 systemd service 启动参数，比如修改端口
$ cat /etc/systemd/system/multi-user.target.wants/kafka-manager.service
...
[Service]
Type=simple
