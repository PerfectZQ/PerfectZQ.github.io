...
$ bin/kafka-manager -Dconfig.file=/usr/share/kafka-manager/conf/application.conf -Dapplication.home=/usr/share/kafka-manager -Dlogger.file=/etc/kafka-manager/logger.xml -Dhttp.port=1911
