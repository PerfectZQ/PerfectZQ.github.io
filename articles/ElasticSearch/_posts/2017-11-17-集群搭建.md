...
## ElasticSearch
* **送一本书(中文))：** [《Elasticsearch 权威指南》](https://www.elastic.co/guide/cn/elasticsearch/guide/current/index.html)，基于ElasticSearch2.0，集群原理可以在这里面找到，其他的最好参考最新版本的使用手册，因为新版本的ES改动很大，尤其是`6.0+`，重要指数★★★☆
